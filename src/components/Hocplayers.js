...
const Hocplayers = () => {
  ...
  useEffect(() => {
    axios.get('http://localhost:5000/api/hocplayers')
 ...
 const handleSubmit = (e) => {
  e.preventDefault();
  axios.post('http://localhost:5000/api/hocplayers', { ...newPlayer, stats: playerStats })
    .then(response => {
  ...
  const handleSaveStats = () => {
    ...
    axios.put(`http://localhost:5000/api/hocplayers/${selectedPlayer._id}/stats`, playerStats)
      .then(response => {
  ...
  const handleDeletePlayer = () => {
    axios.delete(`http://localhost:5000/api/hocplayers/${selectedPlayer._id}`)
      .then(() => {
